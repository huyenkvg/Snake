 ...
 */
public class MangLuoi2D_VeConRanVersion2 extends JPanel implements ActionListener, KeyListener {
    ...
    Timer timer;
    public TheSnake snake = new TheSnake(20, 40, 25);
    ...
    public MangLuoi2D_VeConRanVersion2() {
    ...
    public void paint(Graphics g) {
        ...
        TheSnake doiXungSnake = cars.PhepBienDoi2D.DoiXungConRanQuaO(snake);
        TheSnake doiXungSnakeQuaOx = cars.PhepBienDoi2D.DoiXungConRanQuaOx(snake);
        TheSnake doiXungSnakeQuaOy = cars.PhepBienDoi2D.DoiXungConRanQuaOy(snake);
//        doiXungSnake = cars.PhepBienDoi2D.DoiXungConRan(snake);
        ...
        ToMauVe.ToMauNenChoLuoiPixel2(mangLuoiPixel);

        //================================== VẼ VÒNG QUẸO  ================================================
        ToMauVe.VeVongQueo(mangLuoiPixel, snake);
        ToMauVe.VeVongQueo(mangLuoiPixel, doiXungSnake);
        ToMauVe.VeVongQueo(mangLuoiPixel, doiXungSnakeQuaOx);
        ToMauVe.VeVongQueo(mangLuoiPixel, doiXungSnakeQuaOy);
...
//        
        if(layDoiXungQuaO)
        ToMauVe.VeConRanRa(mangLuoiPixel, doiXungSnake, trangthaiLeLuoi);
        if(layDoiXungQuaOx)
        ToMauVe.VeConRanRa(mangLuoiPixel, doiXungSnakeQuaOx, trangthaiLeLuoi);
        if(layDoiXungQuaOy)
        ToMauVe.VeConRanRa(mangLuoiPixel, doiXungSnakeQuaOy, trangthaiLeLuoi);
